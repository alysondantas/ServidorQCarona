	...
	public void run() {
		try {
			...
			if ((object != null) && (object instanceof String)) {
				...
				System.out.println("\nObjeto recebiddo nï¿½o corresponde " + cliente.getRemoteSocketAddress().toString());
				textField.setText(textField.getText() + "\nObjeto recebiddo nï¿½o corresponde " + cliente.getRemoteSocketAddress().toString());//coloca o log no textArea
